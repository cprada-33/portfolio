...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="min-h-screen py-24 px-6 bg-paper border-b border-stone-300">
      <div className="max-w-4xl mx-auto">
        <div className="mb-20 text-center">
          <span className="block text-accent font-serif italic text-xl tracking-widest mb-2">Chapter II</span>
          <h2 className="text-5xl font-serif font-bold text-ink">The Chronicles</h2>
        ...
        <div className="space-y-12 relative">
           ...
           <div className="relative flex flex-col md:flex-row gap-8 items-center">
              <div className="hidden md:block w-1/2 text-right pr-12">
                  <h3 className="text-2xl font-serif font-bold text-ink">Dread Blue</h3>
                  <span className="inline-block px-2 py-1 bg-stone-100 text-stone-600 text-xs font-sans uppercase tracking-widest mt-2 border border-stone-200">Autonomous Venture</span>
              </div>
              ...
              <div className="w-full md:w-1/2 pl-16 md:pl-12">
                  ...
                  <div className="bg-white p-6 border border-stone-200 shadow-sm relative">
                    ...
                    <p className="font-serif text-stone-700 leading-relaxed">
                      Founded and operated an autonomous development studio. Architected and delivered the full stack solutions featured in the <em>Selected Anthology</em>, managing the entire lifecycle from narrative conception to deployment.
                    </p>
                  </div>
              </div>
           </div>
           ...
           <div className="relative flex flex-col md:flex-row gap-8 items-center">
              <div className="w-full md:w-1/2 pl-16 md:pr-12 md:pl-0 md:text-right order-2 md:order-1">
                   <div className="md:hidden mb-4 pl-16"> {/* Mobile Header */}
                    <h3 className="text-2xl font-serif font-bold text-ink">CI&T</h3>
                    <span className="inline-block px-2 py-1 bg-stone-100 text-stone-600 text-xs font-sans uppercase tracking-widest mt-2 border border-stone-200">Full Stack Developer</span>
                  </div>
                  ...
                  <div className="bg-white p-6 border border-stone-200 shadow-sm relative">
                    ...
                    <p className="font-serif text-stone-700 leading-relaxed">
                      Contributed to the "Coca-Cola en tu hogar" project for the Mexican market. Focused on high-scale e-commerce performance and backend integration within a global consultancy environment.
                    </p>
                  </div>
              </div>
