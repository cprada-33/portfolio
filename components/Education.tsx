...
export const Education: React.FC = () => {
  return (
    <section id="education" className="min-h-screen py-24 px-6 bg-paper-dark border-b border-stone-300">
      <div className="max-w-5xl mx-auto">
        <div className="mb-20 text-center">
          <span className="block text-accent font-serif italic text-xl tracking-widest mb-2">Chapter IV</span>
          <h2 className="text-5xl font-serif font-bold text-ink">The Academia</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative">
           ...
           <div className="md:text-right relative">
              ...
              <div className="bg-paper p-8 border border-stone-200 shadow-sm hover:shadow-md transition-all duration-300 relative group">
                ...
                <h3 className="text-2xl font-serif font-bold text-ink mb-2">Literature</h3>
                <h4 className="font-serif italic text-lg text-stone-700 mb-4">Universidad Pontificia Bolivariana</h4>
                <p className="font-sans text-stone-600 text-sm leading-relaxed">
                   Medellín, Colombia. Focused on narrative theory, critical analysis, and the structural integrity of language.
                </p>
              </div>
           </div>
           ...
           <div className="md:col-start-2 relative mt-8 md:mt-0">
              ...
              <div className="bg-paper p-8 border border-stone-200 shadow-sm hover:shadow-md transition-all duration-300 relative group">
                ...
                <h3 className="text-2xl font-serif font-bold text-ink mb-2">Full Stack Development</h3>
                <h4 className="font-serif italic text-lg text-stone-700 mb-4">Universidad Europea de Madrid</h4>
                <p className="font-sans text-stone-600 text-sm leading-relaxed">
                   Advanced architectural patterns, cloud infrastructure, and modern JavaScript ecosystems. A rigorous study of the full development lifecycle.
                </p>
              </div>
           </div>
           ...
           <div className="md:col-start-1 md:text-right relative mt-8 md:mt-0">
              ...
              <div className="bg-paper p-8 border border-stone-200 shadow-sm hover:shadow-md transition-all duration-300 relative group">
                ...
                <h3 className="text-2xl font-serif font-bold text-ink mb-2">EF SET English Certificate</h3>
                <h4 className="font-serif italic text-lg text-stone-700 mb-4">C2 Proficient Level</h4>
                <p className="font-sans text-stone-600 text-sm leading-relaxed">
                   Demonstrating mastery in English for professional and technical environments.
                </p>
              </div>
           </div>
